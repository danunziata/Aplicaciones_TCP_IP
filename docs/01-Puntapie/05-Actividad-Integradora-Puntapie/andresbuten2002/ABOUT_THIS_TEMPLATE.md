...
├── proyecto_integrador_final             # The main python package for the project
...
e.g: `cat proyecto_integrador_final/VERSION` will get the project version without harming
